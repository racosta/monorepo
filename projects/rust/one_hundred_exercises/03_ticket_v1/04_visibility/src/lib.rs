...
// TODO: **Exceptionally**, you'll be modifying both the `ticket` module and the `tests` module in this exercise.
#[cfg(test)]
mod tests {
  // TODO: Add the necessary `pub` modifiers in the parent module to remove the compiler errors about the use statement below.
  ...
  fn should_not_be_possible() {
    ...
    //    |                         ^^^^^^^^^^^^^^^^^^
    //
    // TODO: Once you have verified that the below does not compile, comment the line out to move on to the next exercise!
    // assert_eq!(ticket.description, "A description");
  }
  ...
  fn encapsulation_cannot_be_violated() {
    ...
    //
    // TODO: Once you have verified that the below does not compile, comment the lines out to move on to the next exercise!
    // let ticket = Ticket {
    //     title: "A title".into(),
