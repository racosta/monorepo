...
In this repository, the environment is managed using [devenv](devenv.sh) and
includes Bazel and other tools used in this repository.

Nix is a prerequisite. Visit
[devenv::Getting started](https://devenv.sh/getting-started/) and use the
